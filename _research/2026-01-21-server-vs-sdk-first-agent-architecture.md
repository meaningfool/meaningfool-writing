...
## 1) The questions this document answers

### Primary decision question

* When building an agent, **do you need a server-first solution**, or is an SDK-first approach sufficient?

### Supporting questions

* What does **server-first** mean (vs **SDK-first**), in practical architecture terms?
* If you **don’t** pick a server-first framework, what **capabilities** will you need to build yourself?
* Where do **OpenCode**, **Claude Agent SDK**, and **pi (badlogic)** fit on this decision axis?

## 2) A tree of questions (from general to specific)

* **A. Should I choose server-first or not?**

  * A1. What “product requirements” force server-first?
  * A2. When is SDK-first simpler and perfectly fine?

* **B. What does “server-first” actually buy me?**

  * B1. What is the service boundary, and who owns it?
  * B2. How does server-first make “more clients later” easier?

* **C. If I choose SDK-first, what do I need to build?**

  * C1. Session lifecycle API (create/run/stream/cancel/resume/fork)
  * C2. Streaming transport to clients
  * C3. Multi-client attachment rules
  * C4. Extensibility governance (tools/hooks/plugins)

* **D. Applying the decision to common frameworks**

  * D1. OpenCode
  * D2. Claude Agent SDK
  * D3. pi (badlogic)

## 3) The decision: do you need server-first?

This section intentionally starts high-level and slightly approximate, to make the choice easy.

### 3.0 “Resumable conversations” has two meanings
...
### 3.1 You likely need a server-first solution if…
...
### 3.2 You likely do NOT need server-first if…
...
## 4) What “server-first” means, concretely
...
## 5) If you choose SDK-first, what you will likely build

This section is the “cost model” of not being server-first.

### 5.1 Session lifecycle API
...
### 5.2 Streaming transport to clients
...
### 5.3 Multi-client attachment rules
...
### 5.4 Extensibility governance (tools/hooks/plugins)
...
* Are you in the **“service-like resumability”** case from **§3.0–§3.2** (i.e., sessions you can **reattach to**, **stream**, and **cancel/interrupt**), rather than just reloading saved history?
